  ...
  return (
    <div className="generalContainer flex">
      ...
      <div className="notificationsBox flex flex-col w-full items-center mt-[100px]">
        <div className="text-3xl text-[#182F40] font-bold pb-[5px] pl-[50px] justify-start w-[830px]">
          Últimas notificaciones
        </div>

        <div className="notificationsCard bg-[#A3BE8C] flex h-[170px] rounded-[20px] text-[#182F40] w-[830px]">
          <div className="leftRow flex flex-col items-end font-bold pr-[20px] basis-1/5 justify-start mt-[20px]">
          ...
          <div className="rightRow flex flex-col items-start basis-4/5 pl-[20px] justify-start mt-[20px]">
            {notificationsData.map((notification, index) => (
